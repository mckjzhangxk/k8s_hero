...
docker pull bats/bats:v1.4.1 --platform amd64
docker tag  bats/bats:v1.4.1 harbor.baijiayun.com/prometheus/bats:v1.4.1
docker push harbor.baijiayun.com/prometheus/bats:v1.4.1
docker rmi  harbor.baijiayun.com/prometheus/bats:v1.4.1